...
更新进度：
----------------
#### 2017.10.27更新个小Tip，webpack的配置中，devtool在打包的时候一定不能用eval等相关的配置项，打出来的包会很大，虽然一些cli已经帮我们做好了这类的工作，但是还是需要了解的。我曾经没有注意过这个问题导致打包出来的js体积比正常的大出了近4倍！
#### 2017.8.21老妈的治疗到今天全部结束，基本康复了，接下来好好保养就好；顺便记点感想...近半个月作为一面面试了很多前端，简历注水真严重啊...
