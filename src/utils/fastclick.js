;(function () {
	...
	*/
	...
	function inputEle(targetElement){
	...
	FastClick.prototype.onTouchStart = function(event) {
		...
		var nodeName = targetElement.nodeName.toLowerCase();
		var typeAttribute = targetElement.getAttribute('type');
		if (nodeName === "textarea" || nodeName === "input" || nodeName === "select" || (typeAttribute === 'date' && nodeName === "input") || (typeAttribute === 'datetime' && nodeName === "input")){
		    return false;
		}
		if (deviceIsIOS) {
